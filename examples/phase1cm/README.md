...
Use this example to create a GDP Central Manager on Azure.
...
Here:
* `[SSH-private-key-file]` is the SSH key you created in the bastion host process and added to Azure.
...
```
cd /opt/guardium_Azure/examples/phase1cm/
```
