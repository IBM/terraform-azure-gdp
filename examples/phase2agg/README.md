...
Use this example to create a GDP Aggregator on Azure.
...
Go to the aggregator directory of your Terraform scripts.

```
cd /opt/guardium_Azure/examples/phase2agg/
```
...
Edit the file `aggregator_config.json` and enter the parameters for your installation.

```
vi aggregator_config.json
```

| Name | Comment |
| ---- | ------- |
| vm_name | Name of the aggregator machine |
