...
# phase2agg/variables.tf
# Variables for Phase 2: Aggregator Deployment
...
variable "agg_config_json_path" {
  ...
  description = "Path to Aggregator configuration JSON file"
}
...
variable "agg_instances_json_path" {
  type        = string
  default     = "aggregator_config.json"
  description = "Path to Aggregator configuration JSON file (legacy name)"
}
