...
# phase3col/variables.tf
# Variables for Phase 3: Collector Deployment
...
variable "col_config_json_path" {
  ...
  description = "Path to Collector configuration JSON file"
}
...
variable "col_instances_json_path" {
  type        = string
  default     = "collector_config.json"
  description = "Path to Collector configuration JSON file (legacy name)"
}
