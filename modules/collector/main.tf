...
# modules/collector/main.tf
# Collector module - Private IP only
...
# ----------------------------
# Automated Collector Configuration
# ----------------------------
...
VM_NAME='${var.vm_name}'
MODULE_PATH='/opt/guardium-azure/modules/collector'

echo ""
echo "=========================================="
echo "PHASE 3: COLLECTOR $VM_NAME DEPLOYMENT"
echo "Private IP: $PRIVATE_IP"
echo "=========================================="
echo "[$(date '+%H:%M:%S')] VM deployed successfully"
echo "[$(date '+%H:%M:%S')] Waiting for Guardium boot..."
...
echo "[$(date '+%H:%M:%S')] Starting Guardium Collector configuration..."
cd "$MODULE_PATH"
...
echo "[$(date '+%H:%M:%S')] Collector configuration completed for $VM_NAME"
echo "=========================================="
EOT
  }
